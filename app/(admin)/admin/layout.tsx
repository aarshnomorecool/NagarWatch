    ...
    <div className="grid gap-4 lg:grid-cols-[220px_1fr]">
      <aside className="surface-card p-4">
        ...
        <nav className="mt-3 flex gap-2 lg:flex-col">
          ...
          <Link href="/admin/escalations" className="btn-secondary px-3 py-2 text-sm font-medium">
            Escalations
          </Link>
          <Link href="/admin/roles" className="btn-secondary px-3 py-2 text-sm font-medium">
            Roles
          </Link>
          <Link href="/admin/broadcast" className="btn-secondary px-3 py-2 text-sm font-medium">
            Broadcast
          </Link>
        </nav>
      </aside>
