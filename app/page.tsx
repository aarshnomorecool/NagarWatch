          ...
          <div className="grid gap-3">
            {!loggedIn ? (
              <article className="rounded-lg border border-amber-300 bg-amber-50 p-4">
                <p className="text-xs font-semibold uppercase tracking-wide text-amber-700">Launch as Citizen</p>
                <p className="mt-1 text-sm text-slate-700">Track civic issues, post complaints, and vote on ongoing problems.</p>
